                ...
                <Form form={form} layout="vertical" name="coupon_form">
                    <Form.Item
                        ...
                        rules={[
                            ...
                            { pattern: /^[A-Z0-9]+$/, message: 'Mã giảm giá chỉ chấp nhận chữ in hoa và số!' },
                        ]}
                    >
                    ...
                    <div className="flex gap-4 mb-2">
                        <Form.Item
                            ...
                            className="flex-1"
                        >
                            <InputNumber min={1} className="w-full" placeholder="Nhập giá trị giảm giá" />
                        </Form.Item>
                        ...
                        <Form.Item
                            ...
                            className="flex-1"
                        >
                            <InputNumber min={1} className="w-full" placeholder="Nhập số lượng mã giảm giá" />
                        </Form.Item>
                    </div>
